...
WMT_fnc_InitModuleTaskArrive        = compileFinal preprocessFile  ("WMT_Tasks\functions\fn_InitModuleTaskArrive.sqf");
WMT_fnc_InitModuleTaskCapturePoints = compileFinal preprocessFile  ("WMT_Tasks\functions\fn_InitModuleTaskCapturePoints.sqf");
