...
WMT_fnc_Reequip                     = compileFinal preprocessFileLineNumbers ("WMT_Main\functions\moduleMain\fn_Reequip.sqf");
WMT_fnc_ReequipStart                = compileFinal preprocessFileLineNumbers ("WMT_Main\functions\moduleMain\fn_ReequipStart.sqf");
